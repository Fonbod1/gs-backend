...
public class JwtUtil {
    ...
    public String generateToken(ExtendedUser userDetails) {
        ...
        claims.put("idEntreprise", userDetails.getIdEntreprise().toString());
        return Jwts.builder()
                .setClaims(claims)
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        final String tokenIdEntreprise = extractIdEntreprise(token);
        ExtendedUser extendedUser = (ExtendedUser) userDetails;

        return username.equals(userDetails.getUsername()) &&
                !isTokenExpired(token) &&
                tokenIdEntreprise.equals(extendedUser.getIdEntreprise().toString());
    }
}
